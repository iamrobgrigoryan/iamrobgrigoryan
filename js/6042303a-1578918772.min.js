...
var gotoPage,inClass,outClass,selectedAnimNumber;if(animation.indexOf('-')!=-1){var randomAnimList=animation.split('-');selectedAnimNumber=parseInt(randomAnimList[(Math.floor(Math.random()*randomAnimList.length))])}else{selectedAnimNumber=parseInt(animation)}
...
NextAnimating=!0;$currentPage.removeClass('pt-page-relative');var $nextPage=$('section[data-id='+gotoPage+']').addClass('pt-page-current');windowArea.scrollTop(0);$('.site-main').scrollTop(0);$currentPage.addClass(outClass).on(animEndEventName,function(){CurrentAnimating=!1;$currentPage.attr('class',$currentPage.data('originalClassList'));$currentPage.off(animEndEventName)});$nextPage.addClass(inClass).on(animEndEventName,function(){NextAnimating=!1;$nextPage.attr('class',$nextPage.data('originalClassList')+' pt-page-current pt-page-relative');$nextPage.off(animEndEventName)})}else{CurrentAnimating=!1;NextAnimating=!1}
if(!support){onEndAnimation($currentPage,$nextPage)}}
function init(options){$('.pt-page').each(function(){var $page=$(this);$page.data('originalClassList',$page.attr('class'))});var menu_html="";$('.pt-wrapper').find('section.pt-page').each(function(){var slug=$(this).attr('data-id');var page_title=$(this).attr('data-title');if(slug.length){var menu_item='<li><a href="#'+slug+'" class="pt-trigger">'+page_title+'</a></li>'}else{var menu_item=''}
...
var menuLink=$(menu+' a[href*="'+location.hash.split('/')[0]+'"]');activeMenuItem(menuLink);Animate(menuLink)}};var menu=options.menu,pageStart=getActiveSection();location.hash=pageStart;var menuLink=$(menu+' a[href*="'+location.hash.split('/')[0]+'"]');activeMenuItem(menuLink);Animate(menuLink);$(".lmpixels-arrow-right").click(function(){var activeItem=$('.site-main-menu li.active');activeItem.next("li").children("a").click();if(activeItem.is(':last-child')){$('.site-main-menu li:first-child').children("a").click()}});$(".lmpixels-arrow-left").click(function(){var activeItem=$('.site-main-menu li.active');activeItem.prev("li").children("a").click();if(activeItem.is(':first-child')){$('.site-main-menu li:last-child').children("a").click()}})}
